...
- [x] Verify the happy path still works after configuration changes.
...
- [x] Add sample input files and one demo project scenario.
...
- [x] Add architecture diagrams and screenshots to project docs.
- [x] Publish a roadmap with open source and future hosted boundaries.

## Future Commercial Boundary

- [x] Keep team governance features out of the open source MVP.
- [x] Reserve hosted-only features for SSO, RBAC, approvals, audit logs, and analytics.
- [x] Define what remains open in the workflow engine versus what becomes hosted/team-only.
